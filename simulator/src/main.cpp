...
int main(int argc, char* argv[]) {
...
#ifdef GL
  gui = new Parser(1200, 660, 880, 660, media_path, scene_file);    
#endif
  ...
  cam_bas = new SimuCameraGL(drone, "bottom camera", 320, 240, 880, 240, 0,0);
  cam_hor = new SimuCameraGL(drone, "horizontal camera", 320, 180, 880, 480, 0, 1);
